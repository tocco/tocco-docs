...
bulk of the history is migrated well before the actual migration. Shortly before the actual migration the tool
can be started again to migrate the remaining entries.
