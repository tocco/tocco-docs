...
This is configured in the :nice:`HibernatePropertiesBuilder <ch/tocco/nice2/persist/hibernate/HibernatePropertiesBuilder>`.
The p6spy driver is currently only configured for the ``development`` environment.

Logging
-------

All statements are passed to the configured :nice:`NiceLogger <ch/tocco/nice2/persist/hibernate/spy/NiceLogger>` by the
p6spy driver.

To decouple the SQL statement consumers from p6spy the :nice:`SpyLoggerService <ch/tocco/nice2/persist/hibernate/spy/SpyLoggerService>`
...
:nice:`SqlLogViewModel <ch/tocco/nice2/devcon/views/persist/sqllogger/SqlLogViewModel>` which publishes the statements
to the DevCon.

The :nice:`NiceLogger <ch/tocco/nice2/persist/hibernate/spy/NiceLogger>` publishes the SQL statements to the
:nice:`SpyLoggerService <ch/tocco/nice2/persist/hibernate/spy/SpyLoggerService>`.
