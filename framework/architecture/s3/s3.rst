...
When an overlay bucket is used, all object are written to it. None are written to the main bucket.
...
Object are deduplicated by means of reference counting. Once the reference counter reaches
